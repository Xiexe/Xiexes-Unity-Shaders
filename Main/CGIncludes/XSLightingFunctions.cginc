        ...
        else
        {
            if(AudioLinkIsAvailable())
            {
                ...
                else
                {
                    ...
                    float smoothsLows = smoothstep((1-audioDataBass), (1-audioDataBass) + (0.5 * fwidth(i.emissionMap.r)), i.emissionMap.r);
                    float smoothsMids = smoothstep((1-audioDataMids), (1-audioDataMids) + (0.5 * fwidth(i.emissionMap.g)), i.emissionMap.g);
                    float smoothsHighs = smoothstep((1-audioDataHighs), (1-audioDataHighs) + (0.5 * fwidth(i.emissionMap.b)), i.emissionMap.b);
